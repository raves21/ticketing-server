...
class BaseRepository
{
    ...
    public function updateById(string $id, array $payload, array $relationships = [])
    {
    ...
    public function updateByRecord(Model $record, array $payload)
    {
        return $record->update($payload);
    }

    public function create(array $payload, array $relationships = [])
    {
